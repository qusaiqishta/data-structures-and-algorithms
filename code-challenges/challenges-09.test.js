...
function transformToLis(obj){
  ...
  newArray.push('<li>'+Object.keys(obj)[i]+': '+Object.values(obj)[i]+'</li>')
  }
...
const addValues = (arr) => {
let sum=0;
let accu=arr.reduce((accu,value,index)=>{
  sum+=value;
},0)
return sum;
};
...
const addPurchases = (arr) => {
  let sum=0;
let acc=arr.reduce((acc,value,index)=>{
